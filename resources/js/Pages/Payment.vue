...
<div class="min-w-screen min-h-screen bg-b2w-300 flex items-center justify-center px-5 pb-10 pt-16">
    <div class="w-full mx-auto rounded-lg bg-b2w-400 shadow-lg p-5 text-gray-700" style="max-width: 600px">
        ...
        <div class="mb-3 flex -mx-2">
            <div class="px-2">
                <label for="type1" class="flex items-center cursor-pointer">
                    <input type="radio" class="form-radio h-5 w-5 text-b2w-900" name="type" id="type1" checked>
                    <img src="https://leadershipmemphis.org/wp-content/uploads/2020/08/780370.png" class="h-8 ml-3">
                </label>
            </div>
            <div class="px-2">
                <label for="type2" class="flex items-center cursor-pointer">
                    <input type="radio" class="form-radio h-5 w-5 text-b2w-900" name="type" id="type2">
        ...
        <div>
            ...
            <button class="block w-full max-w-xs mx-auto bg-b2w-800 hover:bg-b2w-900 focus:bg-b2w-900 text-white rounded-lg px-3 py-3 font-semibold"><i class="mdi mdi-lock-outline mr-1"></i> PAY NOW</button>
            </a>
        </div>
    </div>
</div>
