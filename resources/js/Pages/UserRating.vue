    ...
    <BreezeAuthenticatedLayout>
        ...
        <div class="py-3 sm:max-w-xl sm:mx-auto">
            ...
            <div class="w-full flex flex-col items-center">
                ...
                <span class="text-lg text-white">How was the quality of our service?</span>
                ...
                <button class="py-3 my-8 text-lg bg-b2w-900 rounded-xl text-white filter drop-shadow-md">Rate now</button>
                </div>
            </div>
            <div class="h-20 flex items-center justify-center">
                <a href="/dashboard" class="text-gray-600">Maybe later</a>
            </div>
            </div>
